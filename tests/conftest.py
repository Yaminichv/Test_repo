'''
This module have the data for all the methods to add a option to pytest which is num_records.
'''
...
def generate_test_data(num_records):
    '''
    This method is used to generate test data using the parameter when pytest is called with num_records option.
    '''
    operations = {
        'add': add,
        'subtract': subtract,
...
def pytest_addoption(parser):
    '''
    this method adds the option num_records to pytest
    '''
    parser.addoption("--num_records", action="store", default=5, type=int, help="Number of test records to generate")

def pytest_generate_tests(metafunc):
    '''
    This method is used to generate test cases
    '''
